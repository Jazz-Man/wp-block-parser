...
class BlockParserFrame {
     ...
     * @since 5.0.0
     */
    public function __construct( public BlockParserBlock $block, public int $token_start, public int $token_length, ?int $prev_offset = null, public ?int $leading_html_start = null ) {
